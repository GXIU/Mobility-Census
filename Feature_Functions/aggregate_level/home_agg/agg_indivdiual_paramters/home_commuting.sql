...
--- 提取参数说明
    ...
    --- kurt_daily_movement,
    --- skew_daily_movement
drop table if exists aggregate_commuting_wjy_temp_1;

create table if not exists aggregate_commuting_wjy_temp_1 as
SELECT
    a.home_grid_id,
...
drop table if exists aggregate_commuting_wjy_temp_2;

create table if not exists aggregate_commuting_wjy_temp_2 as
SELECT
    d.home_grid_id,
    avg(
        pow(
...
from
    (
        ...
        from
            ...
            left join aggregate_commuting_wjy_temp_1 c on a.home_grid_id = c.home_grid_id
    ) d
group by
    d.home_grid_id;

drop table if exists aggregate_commuting_wjy;

create table if not exists aggregate_commuting_wjy as
select
    a.home_grid_id,
    a.avg_avg_speed,
    a.std_avg_speed,
...
from
    aggregate_commuting_wjy_temp_1 a
    left join aggregate_commuting_wjy_temp_2 b on a.home_grid_id = b.home_grid_id;